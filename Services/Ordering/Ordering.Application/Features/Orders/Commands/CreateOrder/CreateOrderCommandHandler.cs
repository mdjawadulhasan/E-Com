    ...
    public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand, bool>
    {
        ...
        public async Task<bool> Handle(CreateOrderCommand request, CancellationToken cancellationToken)
        {
            ...
            if (isOrderPlaced)
            {
                ...
                email.Body = $"Dear {order.FirstName + " " + order.LastName} <br/><br/> We are excited for you to received your order #{order.Id} and with notify you one it's way. <br/> Thank you for ordering form Jawad Bhai er E-COM.";
